...
def build_pin_extraction_prompt(datasheet_content: str, part_number: str = None) -> list:
    ...
    if part_number:
        extraction_tasks += (
            ...
            f"- Look for ordering information or package mapping tables\n"
            f"- Match the part number suffix (e.g., RBT7 = 64-pin, RCT6 = 144-pin)\n"
    ...
    messages = [
        {
            ...
            "content": (
                ...
                "1. PHYSICAL FIDELITY: Extract ALL physical pins with their correct numbers. "
                "Never assume Pin 1 is the first signal mentioned - use package diagrams.\n"
                "2. PACKAGE ACCURACY: Extract package type from headings (e.g., '8-Lead SOIC', '28-Pin DIP') "
                "and dimensions from mechanical drawings.\n"
                "3. PACKAGE VARIANT MATCHING: If the datasheet contains multiple package variants, "
                ...
                "4. COMPLETE EXTRACTION: Include ALL pins for the matched variant, not just a sample. "
                "If pinout spans multiple pages, combine everything.\n"
                "5. FUNCTION CLASSIFICATION: Classify each pin's primary function: "
