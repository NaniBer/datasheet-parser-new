    ...
    messages = [
        {
            ...
            "content": (
                ...
                "PIN SEMANTICS (use these EXACT values; use \"unspecified\"/\"other\" when\n"
                "the datasheet does not make it clear - do NOT guess):\n"
                ...
                "- role: supply, ground, input, output, io, clock, reset, enable, control,\n"
                "  address, data, analog, oscillator, thermal, nc, other\n"
                "- active_low: true ONLY if the name clearly marks inversion (overbar,\n"
                "  leading n, trailing #, leading /, _N suffix); else false\n"
                "- nc: true for no-connect pins (NC/DNC/RESERVED). A pin that must be tied\n"
                "  to a net (e.g. \"connect to GND\") has nc=false; put wording in nc_instruction\n"
                "Examples: VCC->power_in/supply; GND->power_in/ground; CLK->input/clock;\n"
                "/RESET->input/reset active_low=true; QA->output/data; EP->passive/thermal;\n"
                "NC->no_connect/nc nc=true.\n\n"
                ...
                "      \"pitch\": null,\n"
                "      \"pins\": [\n"
                "        {\"number\": 1, \"name\": \"VCC\", \"electrical_type\": \"power_in\", \"role\": \"supply\", \"active_low\": false, \"nc\": false},\n"
                "        {\"number\": 2, \"name\": \"QA\", \"electrical_type\": \"output\", \"role\": \"data\", \"active_low\": false, \"nc\": false},\n"
                "        ...\n"
                "      ]\n"
                "    },\n"
                "    {\n"
...
def build_pin_extraction_prompt(
    ...
    system_content = (
        ...
        "9. PIN SEMANTICS: for each pin set these EXACT-valued fields; use "
        "\"unspecified\"/\"other\" when the datasheet is not clear - do NOT guess.\n"
        "   - electrical_type: input, output, bidirectional, tri_state, passive, "
        "power_in, power_out, open_collector, open_emitter, no_connect, unspecified\n"
        "   - role: supply, ground, input, output, io, clock, reset, enable, control, "
        "address, data, analog, oscillator, thermal, nc, other\n"
        "   - active_low: true ONLY if the name clearly marks inversion (overbar, "
        "leading n, trailing #, leading /, _N suffix); else false\n"
        "   - nc: true for NC/DNC/RESERVED pins; a pin that must tie to a net "
        "(e.g. \"connect to GND\") has nc=false with the wording in nc_instruction "
        "(else null)\n\n"
        ...
        "  \"pins\": [\n"
        "    {\"number\": 1, \"name\": \"VCC\", \"electrical_type\": \"power_in\", \"role\": \"supply\", \"active_low\": false, \"nc\": false},\n"
        "    {\"number\": 2, \"name\": \"GND\", \"electrical_type\": \"power_in\", \"role\": \"ground\", \"active_low\": false, \"nc\": false},\n"
        "    ...\n"
        "  ],\n"
